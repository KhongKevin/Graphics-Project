...
// sprites
Sprite background;
const int nFallingSprites = 0;
//FallingSprite fallingSprites[nFallingSprites];

// meshes
string meshNames[] = {"flat_floor", "excavator_mesh"};
...
Camera camera(0, 0, winW, winH, vec3(0, 0, 0), vec3(0, 0, -5), 60.0f, 0.1f, 100.0f);
// interaction
...
string dirMeshes = "D:/kevin/Code/Apps/Assets/";
