...
string dir("C:/Users/Kevin/Code/Apps/Assets/Models/");
vec3 org(1, .55f, 0), blk(0, 0, 0);

// Excavator
const char* excavatorMeshFile = "D:/kevin/Code/Apps/Assets//Models/excavator_mesh.obj";
Mesh excavator;
...
//Excavator Parts
Mesh excavatorTracks;

const char* tracksMeshFile = "D:/kevin/Code/Apps/Assets/Models/tracks.obj";
Mesh excavatorLowerArm;
const char* cabMeshFile = "D:/kevin/Code/Apps/Assets//Models/cabFinal.obj";
Mesh excavatorUpperArm;
const char* lowerArmMeshFile = "D:/kevin/Code/Apps/Assets/Models/lowerArmFinal.obj";
Mesh excavatorCab;
const char* upperArmMeshFile = "D:/kevin/Code/Apps/Assets/Models/Arm.obj";

// Ground
const char* floorMeshFile = "D:/kevin/Code/Apps/Assets/Models/flat_floor.obj";
Mesh floorMesh;
...
int main(int ac, char** av) {
	...
	excavatorTracks.Read(tracksMeshFile, yellowTextureFile); 
	excavatorLowerArm.Read(lowerArmMeshFile, yellowTextureFile); 
	excavatorUpperArm.Read(upperArmMeshFile, yellowTextureFile); 
	excavatorCab.Read(cabMeshFile, yellowTextureFile);
